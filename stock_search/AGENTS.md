...
- `stock_search/data_sources/stockanalysis/adapter.py` -> StockAnalysis provider adapter.
...
- `stock_search/data_sources/stockanalysis/adapter.py` -> statistics/financials/ETF extraction with scrape-first then web-search fallback.
