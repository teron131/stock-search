...
CONVEX_STOCK_LAST_UPDATED_AT = "stock:lastUpdatedAt"
CONVEX_STOCK_GET = "stock:get"
CONVEX_STOCK_GET_MANY = "stock:getMany"
CONVEX_STOCK_UPSERT = "stock:upsert"
CONVEX_STOCK_UPSERT_MANY = "stock:upsertMany"
