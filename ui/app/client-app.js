    ...
    <div className="terminal-layout">
      <div id="slide-menu" className="slide-menu">
        <div className="menu-header">
          ...
          <button type="button" className="close-btn" id="menu-close-btn" aria-label="Close menu">
            &times;
          </button>
        </div>
      ...
      <main className="main-content">
        ...
        <div id="secondary-views">
          <div id="heatmap-section" className="heatmap-container" style={{ display: "none" }}>
            <div className="tabs-header">
              <div className="tab-group">
                <button type="button" className="tab-btn active" data-source="SPX500">
                  S&amp;P_500
                </button>
                <button type="button" className="tab-btn" data-source="NASDAQ100">
                  NASDAQ_100
                </button>
              </div>
            </div>
            <div className="tradingview-widget-container" id="heatmap-widget-container">
              <div className="tradingview-widget-container__widget" />
            </div>
          </div>

          <div id="calendar-section" className="calendar-container" style={{ display: "none" }}>
            <div className="tradingview-widget-container" id="calendar-widget-container">
              <div className="tradingview-widget-container__widget" />
            </div>
          </div>
        </div>
