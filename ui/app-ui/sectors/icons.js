const ICON_DEFS = {
  ...
  grid: {
    paths: ["M2.5 2.5h4v4h-4Z", "M9.5 2.5h4v4h-4Z", "M2.5 9.5h4v4h-4Z", "M9.5 9.5h4v4h-4Z"],
  },
  factory: {
    paths: [
  ...
  news: {
    paths: ["M3.25 2.75h9.5v10.5h-9.5Z", "M5.25 5.25h5.5", "M5.25 7.75h5.5", "M5.25 10.25h3.25"],
  },
  chip: {
    paths: [
      "M5 5h6v6H5Z",
  ...
  plug: {
    paths: ["M6 2.75v3", "M10 2.75v3", "M5.25 5.75h5.5v2a2.75 2.75 0 0 1-2.75 2.75H8v2.75"],
  },
};
