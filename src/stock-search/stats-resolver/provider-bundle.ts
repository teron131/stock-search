...
export class ProviderBundle {
  ...
  private stockAnalysisStatisticsPromise: Promise<Record<string, unknown>> | null = null;
  private stockAnalysisFinancialsPromise: Promise<Record<string, unknown>> | null = null;
  private finvizStatisticsPromise: Promise<Record<string, unknown>> | null = null;
  ...
  getStockAnalysisStatistics(): Promise<Record<string, unknown>> {
    this.stockAnalysisStatisticsPromise ??= this.stockAnalysisSource.getStatisticsSnapshot();
  ...
  getStockAnalysisFinancials(): Promise<Record<string, unknown>> {
    this.stockAnalysisFinancialsPromise ??= this.stockAnalysisSource.getFinancialsSnapshot();
  ...
  getFinvizStatistics(): Promise<Record<string, unknown>> {
    this.finvizStatisticsPromise ??= this.finvizSource.getStatisticsSnapshot().catch(() => ({}));
