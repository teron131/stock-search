...
import { buildEvaluateTickerPayload, buildStandaloneTickerPayload } from "../ticker.js";
...
export const stockSearchTools: readonly StockSearchTool[] = [
  ...
  },
  {
    ...
    execute: async ({ scope }) =>
      buildPortfolioPayload(getStore(), policy.request.portfolioScopeValue(scope)),
  },
  {
    ...
    execute: async ({ ticker, quantity, strategy }) =>
      patchPortfolioPosition(getStore(), String(ticker ?? ""), {
        ...
        strategy: typeof strategy === "string" || strategy === null ? strategy : undefined,
      }),
  },
  {
    ...
    execute: async ({ ticker }) => removePortfolioPosition(getStore(), String(ticker ?? "")),
  },
  {
  ...
  {
    name: "get_stock_news",
    description: "Compatibility alias for raw-fast ticker news. Does not run LLM analysis.",
    parameters: StockNewsToolParametersSchema,
    execute: async (args) => callStockNewsTool(args, newsPipeline.getRawFastNewsAsync),
  },
  {
  ...
  },
  {
    ...
    parameters: StockNewsToolParametersSchema,
    execute: async (args) => callStockNewsTool(args, newsPipeline.getAnalyzedSlowNewsAsync),
  },
  {
  ...
  },
  {
    ...
    execute: async (args) => savePortfolioNews(getStore(), PortfolioNewsWriteSchema.parse(args)),
  },
  {
    name: "get_portfolio_news_summary",
    description: "Return the latest persisted portfolio-level news summary from the shared DB.",
    parameters: PortfolioNewsKeySchema,
    execute: async (args) => {
      const { key } = PortfolioNewsKeySchema.parse(args);
  ...
  },
  {
    ...
    execute: async (args) =>
      savePortfolioNewsSummary(getStore(), PortfolioNewsSummaryWriteSchema.parse(args)),
  },
  {
  ...
  },
  {
    ...
    execute: async ({ ticker }) => buildEvaluateTickerPayload(getStore(), String(ticker ?? "")),
  },
];
...
export async function callTool(
  ...
  const parsedArguments = tool.parameters ? tool.parameters.parse(arguments_) : {};
