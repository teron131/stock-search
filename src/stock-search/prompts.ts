...
export const PORTFOLIO_NEWS_SUMMARY_PROMPT = `Write a chaptered portfolio news summary from already-detailed article summaries.
...
export const MOAT_DEFINITION = `Moat (0-10): replaceability under constraints.
...
export const QUALITY_DEFINITION = `Quality (0-10): ability to turn advantage into durable economics.
...
export const RESEARCH_DEFINITION = `Evaluate the company's Moat and Quality on a 0-10 scale.
${MOAT_DEFINITION}
${QUALITY_DEFINITION}`;
