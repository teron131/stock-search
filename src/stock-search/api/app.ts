...
import { APP_PAGE_PATHS, normalizeAppPagePath, ROOT, SECTORS } from "./route-paths.js";
...
async function readPageHtml(indexFile: string, pathname: string): Promise<string> {
...
async function servePage(indexFile: string, pathname: string): Promise<Response> {
