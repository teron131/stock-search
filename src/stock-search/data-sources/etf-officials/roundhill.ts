...
export function parseRenderedRoundhillHoldingsRows(rows: unknown): OfficialEtfHolding[] {
...
export async function scrapeRoundhillRenderedHoldings(
  ...
  try {
    ...
    const rows = await page.$$eval<string[][]>(RENDERED_HOLDINGS_SELECTOR, (tableRows) =>
