...
export const STATISTICS_SYSTEM_PROMPT = `Extract statistics for {ticker}.
...
export const FINANCIALS_SYSTEM_PROMPT = `Extract financial metrics for {ticker}.
Use this URL as the primary source:
{financials_url}
Only fall back to other stockanalysis.com pages if this page lacks a field.
...
export const ETF_HOLDINGS_SEARCH_SYSTEM_PROMPT = `Find ETF holdings and weightings for {ticker}.
...
export const ETF_SECTOR_SEARCH_SYSTEM_PROMPT = `Find ETF sector allocation percentages for {ticker}.
