...
export type FieldCategory = "market" | "fundamental" | "technical" | "evaluation";
...
export const FIELD_METADATA: Record<string, FieldMetadata> = {
  ...
  fcf_growth_1y: {
    label: "FCF Growth (1Y)",
    shortLabel: "FCF%1Y",
    description: "Latest fiscal-year free cash flow growth versus the prior fiscal year.",
  },
  fcf_margin_median_3y: {
    label: "FCF Margin Median (3Y)",
    shortLabel: "FCFM%3Y",
    description: "Median free-cash-flow margin over the last three fiscal years.",
  },
  financials_currency: {
    label: "Financials Currency",
    shortLabel: "CUR",
    description: "Statement currency used for financial fields before normalization.",
  },
  gross_margin: {
    label: "Gross Margin",
    shortLabel: "GM%",
  ...
  median_upside: {
    label: "Median Upside",
    shortLabel: "UP%",
    description: "Median analyst target upside. Positive means targets sit above spot.",
  },
  moat_score: {
    label: "Moat Score",
    shortLabel: "MOAT",
  ...
  operating_margin_delta_vs_3y: {
    ...
    shortLabel: "OMD%3Y",
    description: "Latest operating margin minus the latest-three-year median operating margin.",
  },
  ...
  operating_margin_std_3y: {
    ...
    shortLabel: "OMSTD%3Y",
    description: "Standard deviation of operating margin over the last three fiscal years.",
  },
  overall_score: {
    label: "Overall Score",
    shortLabel: "SCORE",
  ...
  revenue: {
    label: "Revenue",
    shortLabel: "REV",
    description: "Trailing revenue. Absolute business scale before margins and capital intensity.",
  },
  rank: {
    label: "Rank",
    shortLabel: "RANK",
  ...
  revenue_growth_1y: {
    ...
    shortLabel: "REV%1Y",
    description: "Latest fiscal-year revenue growth versus the prior fiscal year.",
  },
  sales_past_3y_growth: {
    label: "Sales Growth Past 3Y",
    shortLabel: "SALE%3Y",
    description: "Finviz trailing annual sales growth over the past three years.",
  },
  sales_past_5y_growth: {
    label: "Sales Growth Past 5Y",
    shortLabel: "SALE%5Y",
    description: "Finviz trailing annual sales growth over the past five years.",
  },
  eps_growth: {
    label: "EPS Growth",
    shortLabel: "EPS%",
    description: "Per-share earnings growth after margins, interest, tax, and dilution.",
  },
  eps_this_y_growth: {
  ...
  rd_intensity: {
    label: "R&D Intensity",
    shortLabel: "R&D%",
    description: "Latest fiscal-year R&D expense / revenue. Used as currency-safe R&D evidence.",
  },
  ...
  shares_change_1y: {
    ...
    shortLabel: "SH%1Y",
    description: "Latest fiscal-year year-over-year change in shares outstanding.",
  },
  ...
  tactical_score: {
    ...
    shortLabel: "TACT",
    description: "0-10 short-to-medium-term setup score. Does not feed Overall.",
  },
  total: {
  ...
  upside_score: {
    label: "Upside Score",
    shortLabel: "UP",
    description: "0-10 forward return setup score. Higher means stronger upside support.",
  },
  valuation_score: {
    label: "Valuation Score",
    shortLabel: "VAL",
    description: "0-10 valuation score. Higher means cheaper or better-supported value.",
  },
  weight_pct: {
    label: "Weight",
    shortLabel: "WGT%",
...
export const INDICATOR_FIELD_GROUPS = {
  ...
  valuation: {
    ...
    fields: ["market_cap", "pe", "pe_forward", "ps", "ps_forward", "peg", "beta"],
  },
  technicalSnapshot: {
    category: "technical",
    fields: ["iv", "rsi"],
  ...
  momentum: {
    category: "market",
    fields: ["change_percent_1m", "change_percent_3m", "change_percent_6m", "change_percent_1y"],
  },
  analyst: {
    category: "evaluation",
...
export const INDICATOR_FIELDS = INDICATOR_FIELD_DEFINITIONS.map((field) => field.name);
...
export const EVAL_FIELD_DEFINITIONS: readonly EvalFieldDefinition[] = Object.values(
  EVAL_FIELD_GROUPS,
)
  .flat()
